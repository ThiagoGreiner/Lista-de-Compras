...
const saveTodo = (text, done = 0, save = 1) => {
    ...
    pegoBtn.classList.add("finish-todo");
    pegoBtn.innerHTML = '<i class="fa-solid fa-check"></i>';
    todo.appendChild(pegoBtn);

    const editarbtn = document.createElement("button");
    editarbtn.classList.add("edit-todo");
    editarbtn.innerHTML = '<i class="fa-solid fa-pen"></i>';
    todo.appendChild(editarbtn);

    const deletarbtn = document.createElement("button");
    deletarbtn.classList.add("remove-todo");
    deletarbtn.innerHTML = '<i class="fa-solid fa-xmark"></i>';
    todo.appendChild(deletarbtn);

    //Utilzando dados da localStorage
    if(done) {
